...
abstract class $RegisterResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, bool success, String? userId, String? email});
}
...
class _$RegisterResponseImpl implements _RegisterResponse {
  ...
  @override
  String toString() {
    return 'RegisterResponse(message: $message, success: $success, userId: $userId, email: $email)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, success, userId, email);
